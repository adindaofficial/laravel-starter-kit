<div id="starterMobileOverlay" class="fixed inset-0 z-40 hidden bg-slate-950/55 backdrop-blur-sm lg:hidden">
    <div id="starterMobilePanel" class="starter-sidebar-scroll flex min-h-full w-80 max-w-[88vw] -translate-x-full flex-col overflow-y-auto bg-gradient-to-b from-blue-700 via-blue-800 to-blue-950 p-4 text-blue-50 shadow-xl transition-transform duration-200">
        ...
        <div class="mb-4 rounded-lg border border-white/10 bg-white/[.08] p-3">
